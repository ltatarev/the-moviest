...
let DetailsComponent = class DetailsComponent {
    ...
    randomEmoji() {
        let len = _assets_emojis__WEBPACK_IMPORTED_MODULE_7__["emojis"].length;
...
let MovieComponent = class MovieComponent {
    ...
    randomEmoji() {
        let len = _assets_emojis__WEBPACK_IMPORTED_MODULE_8__["emojis"].length;
        let index = Math.floor(Math.random() * len);
...
let ReviewService = class ReviewService {
    ...
    sortByMovieTitle(id = 0, sort) {
        if (id) {
            let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("sort", sort).set("id", id);
            return this.http
                .get(this.reviewUrl + "/sortReviewsByTitleAndAuthor", { params })
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError("sortReviewsByTitleAndAuthor")));
        }
        else {
            let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("sort", sort);
            return this.http
                .get(this.reviewUrl + "/sortReviewsByTitle", { params })
...
let WatchlistService = class WatchlistService {
    ...
    sortByTitle(id = 0, sort) {
        if (id) {
            let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("sort", sort).set("id", id);
            return this.http
                .get(this.watchlistUrl + "/sortWatchlistsByTitleAndAuthor", { params })
                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["catchError"])(this.handleError("sortWatchlistsByTitleAndAuthor")));
        }
        else {
            let params = new _angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpParams"]().set("sort", sort);
            return this.http
                .get(this.watchlistUrl + "/sortWatchlistsByTitle", { params })
