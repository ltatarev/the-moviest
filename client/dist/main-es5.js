...
var SearchResultComponent = /** @class */ (function () {
    function SearchResultComponent(dataProvider) {
        ...
        switch (value.type) {
            case "watchlist":
                this.watchlistService
                    ...
                    .subscribe(function (res) {
                    _this.dataProviderService.setData({ watchlists: res.watchlists, type: "watchlist" });
                });
                break;
            case "review":
                this.reviewService.findReviewByMovie(value.search).subscribe(function (res) {
                    _this.dataProviderService.setData({ reviews: res.reviews, type: "reviews" });
                });
                break;
            case "profile":
            ...
            case "tvShow":
                this.tvService.searchByName(value.search).subscribe(function (res) {
                    _this.dataProviderService.setData({ res: res, type: "tvShow" });
                    _this.router.navigate(["searchResult"]);
                });
                break;
            case "movie":
                this.movieService.searchByName(value.search).subscribe(function (res) {
                    _this.dataProviderService.setData({ res: res, type: "movie" });
                    _this.router.navigate(["searchResult"]);
                });
                break;
        }
